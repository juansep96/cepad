...
$cuotas = [$_POST['idCuota']]; // Array de IDs de cuotas

if (!is_array($cuotas) || empty($cuotas)) {
    echo json_encode(["error" => "No se enviaron cuotas válidas"]);
    exit;
}
...
// SDK de Mercado Pago  
MercadoPago\SDK::setAccessToken('APP_USR-XXXXXXXX');
